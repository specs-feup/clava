...
Logger.prototype.log = function($jp, insertBefore) {
    ...
    var $file = $function.getAncestor('file');
...
Logger.prototype._setup_cxx_specslogger = function($file, $function) {
	...
	var declaredName = this._declareName($function.getDeclaration(true), function(){return IdGenerator.next("clava_logger_");});
...
/*	
    ...
    var declaration = $function.getDeclaration(true);
...
Logger.prototype._setup_cxx_stdcpp_file = function($file, $function) {
	...
	var declaredName = this._declareName($function.getDeclaration(true), function(){return IdGenerator.next("log_file_");});
