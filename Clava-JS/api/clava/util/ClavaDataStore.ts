import WeaverDataStore from "@specs-feup/lara/api/weaver/util/WeaverDataStore.ts";
import ClavaJavaTypes from "../ClavaJavaTypes.ts";
import JavaTypes, {
  type JavaClasses,
} from "@specs-feup/lara/api/lara/util/JavaTypes.ts";
import Io from "@specs-feup/lara/api/lara/Io.ts";
import DataStore from "@specs-feup/lara/api/lara/util/DataStore.ts";
import { arrayFromArgs } from "@specs-feup/lara/api/lara/core/LaraCore.ts";
