...
import CfgEdge from "./CfgEdge.ts";
import CfgEdgeType from "./CfgEdgeType.ts";
import CfgNodeData from "./CfgNodeData.ts";
import CfgNodeType from "./CfgNodeType.ts";
import CfgUtils from "./CfgUtils.ts";
import NextCfgNode from "./NextCfgNode.ts";
import CaseData from "./nodedata/CaseData.ts";
import DataFactory from "./nodedata/DataFactory.ts";
import HeaderData from "./nodedata/HeaderData.ts";
import IfData from "./nodedata/IfData.ts";
import InstListNodeData from "./nodedata/InstListNodeData.ts";
import LoopData from "./nodedata/LoopData.ts";
import ScopeNodeData from "./nodedata/ScopeNodeData.ts";
import SwitchData from "./nodedata/SwitchData.ts";
import GotoData from "./nodedata/GotoData.ts";
import LabelData from "./nodedata/LabelData.ts";
