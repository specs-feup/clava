...
import BenchmarkInstance from "@specs-feup/lara/api/lara/benchmark/BenchmarkInstance.ts";
...
import { Pragma } from "../../Joinpoints.ts";
import CMaker from "../../clava/cmake/CMaker.ts";
