...
export default class HLSAnalysis {
     ...
     *
     */
    static applyGenericStrategies(func, options = {}) {
        ClavaJavaTypes.HighLevelSynthesisAPI.applyGenericStrategies(unwrapJoinPoint(func), JSON.stringify(options));
    }
    /**
     ...
     * */
    static applyFunctionInlining(func, B) {
        ClavaJavaTypes.HighLevelSynthesisAPI.applyFunctionInlining(unwrapJoinPoint(func), B.toString());
    }
    /**
     ...
     * @param func - A JoinPoint of the function to analyze
     * */
    static applyArrayStreaming(func) {
     ...
     * */
    static applyLoopStrategies(func, P) {
     ...
     * */
    static applyLoadStoresStrategy(func, N) {
