...
function(clava_generate ORIG_TARGET GENERATED_TARGET ASPECT) 
	...
	if(NOT EXISTS "${WOVEN_DIR}/clava_generated_files.txt")
		...
		execute_process(
			COMMAND ${CLAVA_CMD} ${ASPECT} ${ASPECT_ARGS_FLAG} ${ASPECT_ARGS} --cmake -p "${PROC_ORIG_SOURCES}" -o ${WORKING_DIR} -of ${WOVEN_DIR_NAME} ${INCLUDE_HEADERS_FLAG} "${PROC_ORIG_INCLUDES}" -ncg ${CLAVA_GENERATE_FLAGS}
	...
	add_custom_command(OUTPUT "${WOVEN_DIR}/clava_generated_files.txt"
		COMMAND ${CLAVA_CMD} ${ASPECT} ${ASPECT_ARGS_FLAG} ${ASPECT_ARGS} --cmake -p "${PROC_ORIG_SOURCES}" -o ${WORKING_DIR} -of ${WOVEN_DIR_NAME} INCLUDE_HEADERS_FLAG "${PROC_ORIG_INCLUDES}" -ncg ${CLAVA_GENERATE_WEAVER_FLAGS}
		#WORKING_DIRECTORY ${ORIG_CMAKE_DIR} 
		#WORKING_DIRECTORY ${BUILD_DIR} 
		WORKING_DIRECTORY ${WORKING_DIR} 
