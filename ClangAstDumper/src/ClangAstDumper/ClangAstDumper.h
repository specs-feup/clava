...
private:
    ...
    void VisitLabelStmtChildren(const LabelStmt *S, std::vector<std::string> &children);
    ...
    void VisitMSPropertyRefExprChildren(const MSPropertyRefExpr *E, std::vector<std::string> &children);

    //void VisitFullExprChildren(const FullExpr *E, std::vector<std::string> &children);
