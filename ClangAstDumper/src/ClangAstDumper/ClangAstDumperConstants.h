...
// For NamedDecls, signals if they do not have a defined name (which is less
// common)
static const std::string DUMP_NAMED_DECL_WITHOUT_NAME =
    "<NamedDecl Without Name>";

static const std::string DUMP_PARM_VAR_DECL_HAS_INHERITED_DEFAULT_ARG =
    "<ParmVarDecl Has Inherited Default Arg>";
...
static const std::string FUNCTION_PROTO_TYPE_EXCEPTION =
    "<FUNCTION_PROTO_TYPE_EXCEPTION>";
