...
const std::string clava::getName(const StmtNode stmtNode) {
  ...
  case clava::StmtNode::FULL_EXPR:
    return "FullExpr";
  case clava::StmtNode::CONSTANT_EXPR:
    return "ConstantExpr";
  case clava::StmtNode::EXPR_WITH_CLEANUPS:
  ...
  default: {
    std::string enumValue = std::to_string(
        static_cast<std::underlying_type<StmtNode>::type>(stmtNode));
    throw std::invalid_argument(
        "ClavaConstants::getDataName(StmtNode):: Case not implemented, '" +
        enumValue + "'");
  }
  }
}
...
const std::string clava::getName(const TypeNode typeNode) {
  ...
  case clava::TypeNode::FUNCTION_NO_PROTO_TYPE:
  ...
  case clava::TypeNode::INCOMPLETE_ARRAY_TYPE:
  ...
  case clava::TypeNode::TYPE_WITH_KEYWORD:
    return "TypeWithKeyword";
  case clava::TypeNode::ELABORATED_TYPE:
    return "ElaboratedType";
  case clava::TypeNode::REFERENCE_TYPE:
    return "ReferenceType";
  case clava::TypeNode::LVALUE_REFERENCE_TYPE:
    return "LValueReferenceType";
  case clava::TypeNode::RVALUE_REFERENCE_TYPE:
  ...
  default: {
    std::string enumValue = std::to_string(
        static_cast<std::underlying_type<TypeNode>::type>(typeNode));
    throw std::invalid_argument(
        "ClavaConstants::getName(TypeNode):: Case not implemented, '" +
        enumValue + "'");
  }
  }
}
...
const std::string clava::getName(const AttrNode attrNode) {
  ...
  default: {
    std::string enumValue = std::to_string(
        static_cast<std::underlying_type<AttrNode>::type>(attrNode));
    throw std::invalid_argument(
        "ClavaConstants::getDataName(AttrNode):: Case not implemented, '" +
        enumValue + "'");
  }
  }
}