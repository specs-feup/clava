...
const std::string clava::getName(const DeclNode declNode) {
  ...
  case clava::DeclNode::USING_SHADOW_DECL:
    return "UsingShadowDecl";
  case clava::DeclNode::TYPEDEF_NAME_DECL:
    return "TypedefNameDecl";
  case clava::DeclNode::TYPE_ALIAS_DECL:
    return "TypeAliasDecl";
  case clava::DeclNode::TYPEDEF_DECL:
    return "TypedefDecl";
  ...
  case clava::DeclNode::LABEL_DECL:
    return "LabelDecl";
  ...
  case clava::DeclNode::VAR_TEMPLATE_SPECIALIZATION_DECL:
  ...
  default: {
    std::string enumValue = std::to_string(
        static_cast<std::underlying_type<DeclNode>::type>(declNode));
    throw std::invalid_argument(
        "ClavaConstants::getDataName(DeclNode):: Case not implemented, '" +
        enumValue + "'");
  }
  }
}