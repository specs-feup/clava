 ...
 *
 * */
MargotStringsGen.prototype.update = function (
    block,
    vars,
    features,
    additionalCode
...
MargotStringsGen.prototype.startMonitor = function (block, monitorName, args) {
    var code =
        ...
        block +
        this._strings.sep +
        this._strings.monitorCode +
        this._strings.sep +
        monitorName +
        this._strings.startCode;
    code += "(";
...
MargotStringsGen.prototype.setGoal = function (block, goalName, goalValue) {
    var code =
        ...
        block +
        this._strings.sep +
        this._strings.goalCode +
        this._strings.sep +
        goalName +
        this._strings.setCode;
    code += "(" + goalValue + ");";
    return code;
};
