...
int main() {
    ...
    //auto mem = new (10) std::vector<int>{1,2,3}; // list-initialization of a non-static member
    auto mem = new (10) std::vector<int>; // list-initialization of a non-static member	
/*
