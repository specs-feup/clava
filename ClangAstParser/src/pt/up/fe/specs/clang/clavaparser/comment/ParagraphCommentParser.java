...
public class ParagraphCommentParser extends AClangNodeParser<ParagraphComment> {

    public ParagraphCommentParser(ClangConverterTable converter) {
        super(converter, false);
    }

    @Override
    protected ParagraphComment parse(ClangNode node, StringParser parser) {
