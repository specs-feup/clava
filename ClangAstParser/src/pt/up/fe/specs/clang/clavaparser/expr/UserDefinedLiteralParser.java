...
public class UserDefinedLiteralParser extends AClangNodeParser<UserDefinedLiteral> {

    public UserDefinedLiteralParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    protected UserDefinedLiteral parse(ClangNode node, StringParser parser) {
        // Examples:
        //
        // 'long double'
