...
public class ExprWithCleanupsParser extends AClangNodeParser<ExprWithCleanups> {

    public ExprWithCleanupsParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    public ExprWithCleanups parse(ClangNode node, StringParser parser) {
        // Examples:
        ...
        return ClavaNodeFactory.exprWithCleanups(valueKind, type, info(node), subExpr);
    }
