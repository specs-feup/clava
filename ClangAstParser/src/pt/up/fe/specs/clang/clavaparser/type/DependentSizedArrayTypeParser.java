...
public class DependentSizedArrayTypeParser extends AClangNodeParser<DependentSizedArrayType> {

    public DependentSizedArrayTypeParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    protected DependentSizedArrayType parse(ClangNode node, StringParser parser) {
