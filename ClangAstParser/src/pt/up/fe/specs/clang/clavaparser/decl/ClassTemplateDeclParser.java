...
public class ClassTemplateDeclParser extends AClangNodeParser<ClassTemplateDecl> {

    public ClassTemplateDeclParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    protected ClassTemplateDecl parse(ClangNode node, StringParser parser) {
        // Examples:
        //
