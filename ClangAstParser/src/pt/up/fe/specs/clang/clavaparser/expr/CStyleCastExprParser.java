...
public class CStyleCastExprParser extends AClangNodeParser<CStyleCastExpr> {

    public CStyleCastExprParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    protected CStyleCastExpr parse(ClangNode node, StringParser parser) {
        // Examples:
        //
        // 'double (*)(std::map<int, Atom>, const int)' <BitCast>
        // 'double' <NoOp>
        // 'float **' <BitCast>
