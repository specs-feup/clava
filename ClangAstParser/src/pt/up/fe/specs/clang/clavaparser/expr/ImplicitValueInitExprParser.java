...
public class ImplicitValueInitExprParser extends AClangNodeParser<ImplicitValueInitExpr> {

    public ImplicitValueInitExprParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    public ImplicitValueInitExpr parse(ClangNode node, StringParser parser) {
