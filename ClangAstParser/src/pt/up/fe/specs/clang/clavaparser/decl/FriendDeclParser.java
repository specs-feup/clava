...
public class FriendDeclParser extends AClangNodeParser<FriendDecl> {

    public FriendDeclParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    protected FriendDecl parse(ClangNode node, StringParser parser) {
