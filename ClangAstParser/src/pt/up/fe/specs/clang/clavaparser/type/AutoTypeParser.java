...
public class AutoTypeParser extends AClangNodeParser<AutoType> {

    public AutoTypeParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    protected AutoType parse(ClangNode node, StringParser parser) {
