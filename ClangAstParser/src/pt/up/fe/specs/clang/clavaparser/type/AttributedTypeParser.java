...
public class AttributedTypeParser extends AClangNodeParser<AttributedType> {

    public AttributedTypeParser(ClangConverterTable converter) {
        super(converter);
    }

    @Override
    protected AttributedType parse(ClangNode node, StringParser parser) {
        // Examples:
        //
        // 'void *(size_t) __attribute__((cdecl))' sugar
