...
public interface ClangAstWebResource {
    ...
    WebResourceProvider LIBC_CXX = create("libc_cxx.zip", "v2.4");
    ...
    WebResourceProvider WIN_EXE = create("windows/clang_ast.exe", "v4.2.7");
    WebResourceProvider WIN_DLL1 = create("windows/libwinpthread-1.dll");
    WebResourceProvider WIN_DLL2 = create("windows/zlib1.dll");

    WebResourceProvider LINUX_EXE = create("linux_ubuntu_18/clang_ast", "v4.2.7");
