...
public interface ClangAstWebResource {
    ...
    WebResourceProvider WIN_EXE = create("windows/clang_ast.exe", "v2.15");
    ...
    WebResourceProvider LINUX_EXE = create("linux_ubuntu_14/clang_ast", "v2.15");

    WebResourceProvider CENTOS6_EXE = create("centos6/clang_ast", "v2.15");

    WebResourceProvider MAC_OS_EXE = create("macos/clang_ast", "v2.15");
