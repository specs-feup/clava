...
public interface ClangAstWebResource {
    ...
    WebResourceProvider WIN_EXE = create("windows/clang_ast.exe", "v4.2.17");
    WebResourceProvider WIN_DLL1 = create("windows/libwinpthread-1.dll");
    WebResourceProvider WIN_DLL2 = create("windows/zlib1.dll");

    WebResourceProvider LINUX_EXE = create("linux_ubuntu_18/clang_ast", "v4.2.17");

    WebResourceProvider LINUX_ARMV7_EXE = create("linux_ubuntu_14_armv7/clang_ast", "v4.2.17");

    WebResourceProvider CENTOS_EXE = create("centos7/clang_ast", "v4.2.17");

    WebResourceProvider MAC_OS_EXE = create("macos/clang_ast", "v4.2.17");
