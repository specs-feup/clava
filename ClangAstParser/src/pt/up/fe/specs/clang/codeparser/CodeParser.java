...
public abstract class CodeParser extends ADataClass<CodeParser> {
    ...
    /**
     * Working directory for files generated by Clava itself. This is an internal
     * parser setting, deliberately not exposed as a weaver option. When present,
     * the dumper invokes clang-dumper from this directory and uses paths relative
     * to it so ccache can reuse a dump produced in another isolated directory.
     */
    public static final DataKey<File> GENERATED_PARSE_ROOT = KeyFactory.folder("generatedParseRoot");
