...
public class IdToClassnameParser extends GenericLineStreamParser {
    ...
    private static final DataKey<Map<String, String>> ID_TO_CLASSNAME_MAP = KeyFactory
            .generic("stream_id_to_class_map", new HashMap<>());

    public static IdToClassnameParser newInstance() {
        return new IdToClassnameParser(getDataKey(), newSnippetParser());
    }
    ...
    private IdToClassnameParser(DataKey<?> key, SnippetParser<?, ?> parser) {
        super(key, parser);
    }
