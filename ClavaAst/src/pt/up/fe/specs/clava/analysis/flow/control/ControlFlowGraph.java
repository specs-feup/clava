...
public class ControlFlowGraph extends FlowGraph {
    ...
    private static String getScopeName(CompoundStmt body) {
        // Check if parent is a FunctionDecl
        var parent = body.getParent();
        if (parent instanceof FunctionDecl) {
            return ((FunctionDecl) parent).getDeclName();
        }

        return parent.getClass().getSimpleName() + "_" + parent.getId();
    }
    ...
    public ControlFlowGraph(CompoundStmt body) {
        super("Control-flow Graph - " + getScopeName(body), "BB");
