...
/**
 * Enumeration for the DFG edge types Black: normal dataflow edge; Red: index dataflow edge; Blue: repetitions (usually
 * used for loops); Orange: dependency tracking (experimental)
 * 
 * @author Tiago
 *
 */
public enum DataFlowEdgeType {
    ...
    /**
     * Checks if an edge is used for control purposes (by definition, only the REPEATING edges are)
     * 
     * @param type
     * @return
     */
