...
public class OMPClauseFactory {
    ...
    public static OMPSharedClause shared(List<String> variables) {
        return new OMPSharedClause(variables);
    }

    public static OMPScheduleClause schedule(ScheduleKind schedule, Integer chunkSize,
