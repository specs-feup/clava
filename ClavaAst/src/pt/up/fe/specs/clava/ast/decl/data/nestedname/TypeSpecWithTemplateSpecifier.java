...
public class TypeSpecWithTemplateSpecifier extends NestedNameSpecifier {

    public final static DataKey<Type> TYPE = KeyFactory.object("type", Type.class);

    public TypeSpecWithTemplateSpecifier() {
        super(NestedNameSpecifierKind.TypeSpecWithTemplate);
    }
}
