 ...
 *
 * This expression always has pseudo-object type, and therefore it is typically not encountered in a fully-type checked
 * expression except within the syntactic form of a PseudoObjectExpr.
 *
 * @author jbispo
 *
 */
public class MSPropertyRefExpr extends Expr {
    ...
    public boolean isOnLeftSideOfAssign() {
        // Check if immediate parent is a binary operator expression, and if node is on the left side
        ...
        var op = parent.get(BinaryOperator.OP);
    ...
    public String getCode() {
        ...
        var propertyString = isOnLeftSide ? property.get(MSPropertyDecl.SETTER_NAME)
                : property.get(MSPropertyDecl.GETTER_NAME);
