 ...
 */
public abstract class AUndefinedType extends AType {
     ...
     * 
     */
    public AUndefinedType(AType aType){
        this.aType = aType;
    }
    /**
     ...
     * 
     */
    protected enum UndefinedTypeAttributes {
        KIND("kind"),
         ...
         * 
         */
        private UndefinedTypeAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<UndefinedTypeAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(UndefinedTypeAttributes::name).collect(Collectors.toList());
        }
