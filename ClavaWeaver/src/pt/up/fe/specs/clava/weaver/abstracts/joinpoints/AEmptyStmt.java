...
/**
 * Auto-Generated class for join point AEmptyStmt
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AEmptyStmt extends AStatement {
     ...
     * 
     */
    public AEmptyStmt(AStatement aStatement){
     ...
     * 
     */
    protected enum EmptyStmtAttributes {
        ISFIRST("isFirst"),
        ISLAST("isLast"),
        PARENT("parent"),
        AST("ast"),
         ...
         * 
         */
        private EmptyStmtAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<EmptyStmtAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(EmptyStmtAttributes::name).collect(Collectors.toList());
        }
