...
public abstract class AVarref extends AExpression {
     ...
     * 
     */
    public AVarref(AExpression aExpression){
     ...
     * 
     */
    protected enum VarrefAttributes {
         ...
         * 
         */
        private VarrefAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<VarrefAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(VarrefAttributes::name).collect(Collectors.toList());
        }
