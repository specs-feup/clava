...
/**
 * Auto-Generated class for join point AGotoStmt
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AGotoStmt extends AStatement {
     ...
     * 
     */
    public AGotoStmt(AStatement aStatement){
     ...
     */
    public abstract ALabelDecl getLabelImpl();
    ...
    protected enum GotoStmtAttributes {
         ...
         * 
         */
        private GotoStmtAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<GotoStmtAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(GotoStmtAttributes::name).collect(Collectors.toList());
        }
