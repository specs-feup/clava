...
public class CxxWrapperStmt extends AWrapperStmt {
    ...
    public CxxWrapperStmt(WrapperStmt wrapperStmt, ACxxWeaverJoinPoint parent) {
        super(new CxxStatement(wrapperStmt, parent));
    ...
    public AJoinPoint getContentImpl() {
        return CxxJoinpoints.create(wrapperStmt.getWrappedNode(), this);
    }
