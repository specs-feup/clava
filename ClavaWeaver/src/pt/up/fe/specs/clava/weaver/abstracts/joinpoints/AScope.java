...
/**
 * Auto-Generated class for join point AScope This class is overwritten by the
 * Weaver Generator.
 * 
 * 
...
public abstract class AScope extends AStatement {
    ...
    /**
     * The number of statements in the scope, including the statements inside the
     * declaration and bodies of structures such as ifs and loops, and not
     * considering comments and pragmas
     */
	...
	throw new UnsupportedOperationException(
		"Join point " + get_class() + ": Action def naked with type Boolean not implemented ");
    }
    ...
    /**
     * Default implementation of the method used by the lara interpreter to select
     * stmts
     * 
     * @return
     */
    ...
    /**
     * Sets the 'naked' status of a scope (a scope is naked if it does not have
     * curly braces)
     * 
     * @param isNaked
     */
	...
	NUMSTATEMENTS("numStatements"), NAKED("naked"), STMTS("stmts"), FIRSTSTMT("firstStmt"), LASTSTMT("lastStmt"),
	OWNER("owner"), ISFIRST("isFirst"), ISLAST("isLast"), PARENT("parent"), ASTANCESTOR("astAncestor"), AST("ast"),
	DATA("data"), HASCHILDREN("hasChildren"), DESCENDANTSANDSELF("descendantsAndSelf"), TYPE("type"),
	ISCILK("isCilk"), FILEPATH("filepath"), CHILDREN("children"), FIRSTCHILD("firstChild"),
	NUMCHILDREN("numChildren"), ANCESTOR("ancestor"), ASTCHILD("astChild"), ASTNAME("astName"), JPID("jpId"),
	ASTID("astId"), CONTAINS("contains"), ASTISINSTANCE("astIsInstance"), FILENAME("filename"),
	JAVAFIELDS("javaFields"), ASTPARENT("astParent"), USERFIELD("userField"), HASNODE("hasNode"), CHILD("child"),
	ENDLINE("endLine"), ENDCOLUMN("endColumn"), CODE("code"), ISINSIDELOOPHEADER("isInsideLoopHeader"),
	LINE("line"), KEYS("keys"), ISINSIDEHEADER("isInsideHeader"), ASTNUMCHILDREN("astNumChildren"),
	DESCENDANTS("descendants"), ASTCHILDREN("astChildren"), ISMACRO("isMacro"), LASTCHILD("lastChild"),
	ROOT("root"), JAVAVALUE("javaValue"), KEYTYPE("keyType"), CHAINANCESTOR("chainAncestor"), CHAIN("chain"),
	JOINPOINTTYPE("joinpointType"), CURRENTREGION("currentRegion"), HASASTPARENT("hasAstParent"), COLUMN("column"),
	PARENTREGION("parentRegion"), GETVALUE("getValue"), FIRSTJP("firstJp"), DEPTH("depth"),
	JAVAFIELDTYPE("javaFieldType"), LOCATION("location"), GETUSERFIELD("getUserField"), PRAGMAS("pragmas"),
	HASPARENT("hasParent");
