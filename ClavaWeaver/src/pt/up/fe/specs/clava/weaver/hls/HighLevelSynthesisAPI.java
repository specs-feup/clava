...
public class HighLevelSynthesisAPI {
     ...
     *            the function to analyze
     * @param B
     *            function inlining control parameter (defines whether the inlining should be more
     *            permissive/aggressive)
     */
    public static void applyFunctionInlining(AFunction cxxFun, String B) {
     ...
     *            the function to analyze
     */
    public static void applyArrayStreaming(AFunction cxxFun) {
     ...
     *            the function to analyze
     */
    public static void applyLoopStrategies(AFunction cxxFun, String P) {
     ...
     *            the function to analyze
     * @param N
     *            the load/stores parameter (positive integer)
     */
    public static void applyLoadStoresStrategy(AFunction cxxFun, String N) {
    ...
    public static boolean canBeInstrumented(AFunction cxxFun) {
     ...
     * 
     * @param cxxFun
     *            the function to use on HLS analysis
     * @return
     */
    private static ClavaHLS createHLS(AFunction cxxFun) {
        FunctionDecl fun = (FunctionDecl) cxxFun.getNode();
