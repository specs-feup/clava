 ...
 */
public abstract class ALabelDecl extends ANamedDecl {
     ...
     * 
     */
    public ALabelDecl(ANamedDecl aNamedDecl){
        super(aNamedDecl);
    ...
    public AJoinPoint[] getJpFieldsRecursiveArrayImpl() {
        return this.aNamedDecl.getJpFieldsRecursiveArrayImpl();
    }
    ...
    protected enum LabelDeclAttributes {
         ...
         * 
         */
        private LabelDeclAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<LabelDeclAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(LabelDeclAttributes::name).collect(Collectors.toList());
        }
