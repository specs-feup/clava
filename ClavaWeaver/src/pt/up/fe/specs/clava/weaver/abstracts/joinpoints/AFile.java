...
public abstract class AFile extends ACxxWeaverJoinPoint {
    ...
    public String getDestinationFilepathImpl(String destinationFolderpath) {
        throw new UnsupportedOperationException(get_class()+": Action getDestinationFilepath not implemented ");
    }
     ...
     * @param destinationFolderpath 
     */
    public final String getDestinationFilepath(String destinationFolderpath) {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAction(Stage.BEGIN, "getDestinationFilepath", this, Optional.empty(), destinationFolderpath);
        	}
        	String result = this.getDestinationFilepathImpl(destinationFolderpath);
        	if(hasListeners()) {
        		eventTrigger().triggerAction(Stage.END, "getDestinationFilepath", this, Optional.ofNullable(result), destinationFolderpath);
        	}
        	return result;
        } catch(Exception e) {
        	throw new ActionException(get_class(), "getDestinationFilepath", e);
        }
    }
    ...
    protected final void fillWithActions(List<String> actions) {
        ...
        actions.add("String getDestinationFilepath(String)");
