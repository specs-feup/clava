...
public class CxxArrayType extends AArrayType {
    ...
    public CxxArrayType(ArrayType arrayType, ACxxWeaverJoinPoint parent) {
        super(new CxxType(arrayType, parent));
    ...
    public AType getElementTypeImpl() {
        return CxxJoinpoints.create(arrayType.getElementType(), this, AType.class);
    }
}
