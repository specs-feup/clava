...
/**
 * Auto-Generated class for join point AParenExpr
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AParenExpr extends AExpression {
     ...
     * 
     */
    public AParenExpr(AExpression aExpression){
     ...
     * 
     */
    protected enum ParenExprAttributes {
        SUBEXPR("subExpr"),
        DECL("decl"),
         ...
         * 
         */
        private ParenExprAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<ParenExprAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(ParenExprAttributes::name).collect(Collectors.toList());
        }
