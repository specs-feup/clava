 ...
 */
public abstract class ADeclStmt extends AStatement {
     ...
     * 
     */
    public ADeclStmt(AStatement aStatement){
        this.aStatement = aStatement;
    }
    /**
     * Get value on attribute decls
     * @return the attribute's value
     */
    public abstract ADecl[] getDeclsArrayImpl();
     ...
     * 
     */
    protected enum DeclStmtAttributes {
        DECLS("decls"),
        ISFIRST("isFirst"),
        ISLAST("isLast"),
        PARENT("parent"),
         ...
         * 
         */
        private DeclStmtAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<DeclStmtAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(DeclStmtAttributes::name).collect(Collectors.toList());
        }
