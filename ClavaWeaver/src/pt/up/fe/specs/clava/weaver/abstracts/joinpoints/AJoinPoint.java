...
public abstract class AJoinPoint extends JoinPoint {
    ...
    /**
     * Performs a copy of the node and its children, including the nodes in their fields (only the first level of field
     * nodes, this function is not recursive)
     */
    ...
    public final Object setUserField(String fieldName, Object value) {
        try {
            ...
            if (hasListeners()) {
                eventTrigger().triggerAction(Stage.END, "setUserField", this, Optional.ofNullable(result), fieldName,
                        value);
            }
            return result;
        } catch (Exception e) {
    ...
    public final Object setUserField(Map<?, ?> fieldNameAndValue) {
        try {
            ...
            if (hasListeners()) {
                eventTrigger().triggerAction(Stage.END, "setUserField", this, Optional.ofNullable(result),
                        fieldNameAndValue);
            }
            return result;
        } catch (Exception e) {
     ...
     * @param suffix
     */
    public final AJoinPoint toComment(String prefix, String suffix) {
        try {
            if (hasListeners()) {
    ...
    public final void setInlineComments(String[] comments) {
        try {
            if (hasListeners()) {
                eventTrigger().triggerAction(Stage.BEGIN, "setInlineComments", this, Optional.empty(),
                        new Object[] { comments });
            }
            this.setInlineCommentsImpl(comments);
            if (hasListeners()) {
                eventTrigger().triggerAction(Stage.END, "setInlineComments", this, Optional.empty(),
                        new Object[] { comments });
            }
        } catch (Exception e) {
    ...
    public final Object descendantsAndSelf(String type) {
        try {
            ...
            if (hasListeners()) {
                eventTrigger().triggerAttribute(Stage.END, this, "descendantsAndSelf", Optional.ofNullable(result),
                        type);
            }
            return result != null ? result : getUndefinedValue();
        } catch (Exception e) {
    ...
    public void defTypeImpl(AType value) {
        throw new UnsupportedOperationException(
                "Join point " + get_class() + ": Action def type with type AType not implemented ");
    }
    ...
    /**
     * The bit width of the type returned by this join point, in relation to the definitions of its Translation Unit, or
     * undefined if there is no type or bitwidth defined, or if the join point is not in a TranslationUnit
     */
    ...
    public final Object astIsInstance(String className) {
        try {
            ...
            if (hasListeners()) {
                eventTrigger().triggerAttribute(Stage.END, this, "astIsInstance", Optional.ofNullable(result),
                        className);
            }
            return result != null ? result : getUndefinedValue();
        } catch (Exception e) {
    ...
    public final Object javaFieldType(String fieldName) {
        try {
            ...
            if (hasListeners()) {
                eventTrigger().triggerAttribute(Stage.END, this, "javaFieldType", Optional.ofNullable(result),
                        fieldName);
            }
            return result != null ? result : getUndefinedValue();
        } catch (Exception e) {
    ...
    public final Object getUserField(String fieldName) {
        try {
            ...
            if (hasListeners()) {
                eventTrigger().triggerAttribute(Stage.END, this, "getUserField", Optional.ofNullable(result),
                        fieldName);
            }
            return result != null ? result : getUndefinedValue();
        } catch (Exception e) {
    ...
    /**
     * JS object associated with this node, containing parsed data of #pragma clava data when the node can be a target
     * of pragmas. This is a special object, managed internally, and cannot be reassigned, to change its contents
     * requires using key-value pairs. If the node can be the target of a pragma, the information stored in this object
     * is persisted between rebuilds.
     */
    ...
    public void defDataImpl(Object value) {
        throw new UnsupportedOperationException(
                "Join point " + get_class() + ": Action def data with type Object not implemented ");
    }
    ...
    public void defFirstChildImpl(AJoinPoint value) {
        throw new UnsupportedOperationException(
                "Join point " + get_class() + ": Action def firstChild with type AJoinPoint not implemented ");
    }
    ...
    public void defLastChildImpl(AJoinPoint value) {
        throw new UnsupportedOperationException(
                "Join point " + get_class() + ": Action def lastChild with type AJoinPoint not implemented ");
    }
    ...
    /**
     * the depth of this join point in the AST. If it is the root join point returns 0, if it is a child of the root
     * node returns 1, etc.
     */
    ...
    /**
     * Id that is based on the position of the node in the code, and should remain stable between compilations (warning:
     * only a few nodes - file, function, loop - currently support it)
     */
    ...
    /**
     * the nodes of the scope of the current join point. If this node has a body (e.g., loop, function) corresponds to
     * the children of the body. Otherwise, returns an empty array
     */
    ...
    public void defInlineCommentsImpl(String[] value) {
        throw new UnsupportedOperationException(
                "Join point " + get_class() + ": Action def inlineComments with type String not implemented ");
    }
