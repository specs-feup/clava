...
/**
 * Auto-Generated class for join point AImplicitValue
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AImplicitValue extends AExpression {
     ...
     * 
     */
    public AImplicitValue(AExpression aExpression){
     ...
     * 
     */
    protected enum ImplicitValueAttributes {
        DECL("decl"),
         ...
         * 
         */
        private ImplicitValueAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<ImplicitValueAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(ImplicitValueAttributes::name).collect(Collectors.toList());
        }
