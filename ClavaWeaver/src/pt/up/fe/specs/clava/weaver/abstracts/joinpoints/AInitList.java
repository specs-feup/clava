...
/**
 * Auto-Generated class for join point AInitList
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AInitList extends AExpression {
     ...
     * 
     */
    public AInitList(AExpression aExpression){
     ...
     */
    public abstract AExpression getArrayFillerImpl();
    ...
    public final Object getArrayFiller() {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.BEGIN, this, "arrayFiller", Optional.empty());
        	}
        	AExpression result = this.getArrayFillerImpl();
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.END, this, "arrayFiller", Optional.ofNullable(result));
        	}
    ...
    public AJoinPoint[] getJpFieldsRecursiveArrayImpl() {
        return this.aExpression.getJpFieldsRecursiveArrayImpl();
    }
     ...
     * 
     */
    protected enum InitListAttributes {
         ...
         * 
         */
        private InitListAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<InitListAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(InitListAttributes::name).collect(Collectors.toList());
        }
