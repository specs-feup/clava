...
/**
 * Auto-Generated class for join point AReturnStmt
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AReturnStmt extends AStatement {
    ...
    protected enum ReturnStmtAttributes {
         ...
         * 
         */
        private ReturnStmtAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<ReturnStmtAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(ReturnStmtAttributes::name).collect(Collectors.toList());
        }
