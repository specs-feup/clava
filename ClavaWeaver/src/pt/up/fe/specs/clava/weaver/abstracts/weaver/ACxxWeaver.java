...
public abstract class ACxxWeaver extends WeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"replaceWith", "replaceWith", "insertBefore", "insertBefore", "insertAfter", "insertAfter", "detach", "setType", "copy", "deepCopy", "setUserField", "setUserField", "setValue", "rebuild", "addFile", "push", "pop", "addExtraInclude", "addExtraIncludeFromGit", "addExtraSource", "addExtraSourceFromGit", "addInclude", "addInclude", "addIncludeJp", "addGlobal", "write", "messageToUser", "rebuild", "setName", "setName", "wrap", "inline", "setArgFromString", "setArg", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "addFunction", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "addLocal", "addLocal", "setNaked", "clone", "cloneOnFile", "cloneOnFile", "clear", "insertReturn", "insertReturn", "setParams", "setParamsFromStrings", "setBody", "setName", "changeKind", "setKind", "setInit", "setInitValue", "setEndValue", "setCond", "setStep", "setIsParallel", "interchange", "tile", "tile", "setCondRelation", "setCondRelation", "setKind", "removeClause", "setNumThreads", "setProcBind", "setPrivate", "setReduction", "setDefault", "setFirstprivate", "setLastprivate", "setShared", "setCopyin", "setScheduleKind", "setScheduleChunkSize", "setScheduleModifiers", "setCollapse", "setOrdered", "setOrdered", "setName", "setContent", "setInit", "setInit", "setName", "newCall", "setReturnType", "setTemplateArgsTypes", "setTemplateArgsTypes", "setDesugar", "setArgType", "setPointee", "setSizeExpr"};
