...
public abstract class ACxxWeaver extends WeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"replaceWith", "insertBefore", "insertBefore", "insertAfter", "insertAfter", "detach", "setType", "copy", "setUserField", "setUserField", "rebuild", "addFile", "push", "pop", "addExtraInclude", "addExtraIncludeFromGit", "addExtraSource", "addExtraSourceFromGit", "addInclude", "addInclude", "addIncludeJp", "addGlobal", "write", "messageToUser", "setName", "wrap", "inline", "setArgFromString", "setArg", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "addFunction", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "addLocal", "addLocal", "clone", "cloneOnFile", "cloneOnFile", "clear", "insertReturn", "insertReturn", "changeKind", "setKind", "setInit", "setInitValue", "setCond", "setStep", "setIsParallel", "interchange", "tile", "setKind", "removeClause", "setNumThreads", "setProcBind", "setPrivate", "setReduction", "setDefault", "setFirstprivate", "setLastprivate", "setShared", "setCopyin", "setScheduleKind", "setScheduleChunkSize", "setScheduleModifiers", "setCollapse", "setOrdered", "setOrdered", "setName", "setContent", "setInit", "setInit", "setName", "setName", "call", "setReturnType", "setTemplateArgsTypes", "setTemplateArgsTypes", "setNaked"};
