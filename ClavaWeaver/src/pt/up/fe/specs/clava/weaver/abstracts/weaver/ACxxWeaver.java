...
public abstract class ACxxWeaver extends WeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"replaceWith", "insertBefore", "insertBefore", "insertAfter", "insertAfter", "detach", "setType", "rebuild", "addFile", "push", "pop", "addInclude", "addInclude", "addIncludeJp", "addGlobal", "write", "messageToUser", "setName", "wrap", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "addFunction", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "clone", "cloneOnFile", "cloneOnFile", "clear", "insertReturn", "insertReturn", "changeKind", "setKind", "setInit", "setCond", "setStep", "interchange", "tile", "setKind", "removeClause", "setNumThreads", "setProcBind", "setPrivate", "setReduction", "setDefault", "setFirstprivate", "setLastprivate", "setShared", "setCopyin", "setScheduleKind", "setScheduleChunkSize", "setScheduleModifiers", "setCollapse", "setOrdered", "setOrdered", "setName", "setContent", "setInit", "setInit"};
