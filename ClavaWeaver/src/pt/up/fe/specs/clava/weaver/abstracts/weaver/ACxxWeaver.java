...
public abstract class ACxxWeaver extends WeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"replaceWith", "replaceWith", "replaceWith", "replaceWithStrings", "insertBefore", "insertBefore", "insertAfter", "insertAfter", "detach", "setType", "copy", "deepCopy", "setUserField", "setUserField", "setValue", "messageToUser", "removeChildren", "setFirstChild", "setLastChild", "toComment", "toComment", "toComment", "setInlineComments", "setInlineComments", "setData", "dataAssign", "dataClear", "rebuild", "rebuildFuzzy", "addFile", "addFileFromPath", "push", "pop", "addExtraInclude", "addExtraIncludeFromGit", "addExtraIncludeFromGit", "addExtraSource", "addExtraSourceFromGit", "addExtraSourceFromGit", "addProjectFromGit", "addProjectFromGit", "addExtraLib", "atexit", "addInclude", "addInclude", "addIncludeJp", "addCInclude", "addCInclude", "addGlobal", "write", "setName", "rebuild", "rebuildTry", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "addFunction", "setRelativeFolderpath", "addField", "addMethod", "setName", "wrap", "inline", "setArgFromString", "setArg", "addArg", "addArg", "addArg", "setConfig", "setConfigFromStrings", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "insertReturn", "insertReturn", "addLocal", "addLocal", "setNaked", "clear", "cfg", "dfg", "clone", "clone", "cloneOnFile", "cloneOnFile", "cloneOnFile", "insertReturn", "insertReturn", "setParams", "setParamsFromStrings", "setParam", "setParam", "setParam", "setBody", "newCall", "setFunctionType", "setReturnType", "setParamType", "addParam", "addParam", "addParam", "removeRecord", "setName", "setQualifiedPrefix", "setQualifiedName", "changeKind", "setKind", "setInit", "setInitValue", "setEndValue", "setCond", "setStep", "setIsParallel", "interchange", "tile", "tile", "setCondRelation", "setCondRelation", "setBody", "setCond", "setThen", "setElse", "setLabel", "setDecl", "setKind", "removeClause", "setNumThreads", "setProcBind", "setPrivate", "setReduction", "setDefault", "setFirstprivate", "setLastprivate", "setShared", "setCopyin", "setScheduleKind", "setScheduleChunkSize", "setScheduleChunkSize", "setScheduleModifiers", "setCollapse", "setCollapse", "setOrdered", "setOrdered", "setText", "setName", "setContent", "setInit", "setInit", "removeInit", "removeInit", "varref", "setStorageClass", "setName", "setLeft", "setRight", "setArrow", "setTemplateArgsTypes", "setTemplateArgsTypes", "setDesugar", "setTypeFieldByValueRecursive", "setUnderlyingType", "asConst", "setReturnType", "setParamType", "setArgType", "setPointee", "setElementType", "setSizeExpr", "setInnerType"};
