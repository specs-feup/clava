...
public abstract class ACxxWeaver extends LaraWeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"getAncestor", "getDescendants", "replaceWith", "replaceWith", "replaceWith", "replaceWithStrings", "insertBefore", "insertBefore", "insertAfter", "insertAfter", "detach", "setType", "copy", "deepCopy", "setUserField", "setUserField", "setValue", "messageToUser", "removeChildren", "setFirstChild", "setLastChild", "toComment", "setInlineComments", "setInlineComments", "setData", "dataAssign", "dataClear", "rebuild", "rebuildFuzzy", "addFile", "addFileFromPath", "push", "pop", "addExtraInclude", "addExtraIncludeFromGit", "addExtraSource", "addExtraSourceFromGit", "addProjectFromGit", "addExtraLib", "atexit", "addInclude", "addIncludeJp", "addCInclude", "addGlobal", "write", "setName", "rebuild", "rebuildTry", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "addFunction", "setRelativeFolderpath", "addField", "addMethod", "setName", "wrap", "inline", "setArgFromString", "setArg", "addArg", "addArg", "setConfig", "setConfigFromStrings", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "insertReturn", "insertReturn", "addLocal", "setNaked", "clear", "cfg", "dfg", "clone", "cloneOnFile", "cloneOnFile", "insertReturn", "insertReturn", "setParams", "setParamsFromStrings", "setParam", "setParam", "setBody", "newCall", "setFunctionType", "setReturnType", "setParamType", "addParam", "addParam", "removeRecord", "setName", "setQualifiedPrefix", "setQualifiedName", "changeKind", "setKind", "setInit", "setInitValue", "setEndValue", "setCond", "setStep", "setIsParallel", "interchange", "tile", "setCondRelation", "setCondRelation", "setBody", "setCond", "setThen", "setElse", "setLabel", "setDecl", "setKind", "removeClause", "setNumThreads", "setProcBind", "setPrivate", "setReduction", "setDefault", "setFirstprivate", "setLastprivate", "setShared", "setCopyin", "setScheduleKind", "setScheduleChunkSize", "setScheduleChunkSize", "setScheduleModifiers", "setCollapse", "setCollapse", "setOrdered", "setText", "setName", "setContent", "setInit", "setInit", "removeInit", "varref", "setStorageClass", "setName", "setLeft", "setRight", "setArrow", "setTemplateArgsTypes", "setTemplateArgType", "setDesugar", "setTypeFieldByValueRecursive", "setUnderlyingType", "asConst", "setReturnType", "setParamType", "setArgType", "setPointee", "setElementType", "setSizeExpr", "setInnerType"};
