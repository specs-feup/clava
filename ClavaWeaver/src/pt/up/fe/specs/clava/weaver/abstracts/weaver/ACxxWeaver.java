...
public abstract class ACxxWeaver extends LaraWeaverEngine {
    ...
    public final List<String> getActions() {
        String[] weaverActions= {"astIsInstance", "getChainAncestor", "contains", "getFirstJp", "getChild", "getAstChild", "getAncestor", "getDescendants", "getDescendantsAndSelf", "getJavaFieldType", "getKeyType", "replaceWith", "replaceWith", "replaceWith", "replaceWithStrings", "insertBefore", "insertBefore", "insertAfter", "insertAfter", "detach", "setType", "copy", "deepCopy", "setUserField", "setUserField", "setValue", "messageToUser", "removeChildren", "setFirstChild", "setLastChild", "toComment", "setInlineComments", "setInlineComments", "setData", "dataAssign", "dataClear", "rebuild", "rebuildFuzzy", "addFile", "addFileFromPath", "push", "pop", "addExtraInclude", "addExtraIncludeFromGit", "addExtraSource", "addExtraSourceFromGit", "addProjectFromGit", "addExtraLib", "atexit", "addInclude", "addIncludeJp", "addCInclude", "addGlobal", "getDestinationFilepath", "write", "setName", "rebuild", "rebuildTry", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "addFunction", "setRelativeFolderpath", "addField", "addMethod", "getArg", "setName", "wrap", "inline", "setArgFromString", "setArg", "addArg", "addArg", "setConfig", "setConfigFromStrings", "insertBegin", "insertBegin", "insertEnd", "insertEnd", "insertReturn", "insertReturn", "addLocal", "setNaked", "clear", "cfg", "dfg", "getNumStatements", "clone", "cloneOnFile", "cloneOnFile", "getDeclaration", "getValue", "getUserField", "hasNode", "insertReturn", "insertReturn", "setParams", "setParamsFromStrings", "setParam", "setParam", "setBody", "newCall", "setFunctionType", "setReturnType", "setParamType", "addParam", "addParam", "removeRecord", "setName", "setQualifiedPrefix", "setQualifiedName", "isInterchangeable", "setKind", "setInit", "setInitValue", "setEndValue", "setCond", "setStep", "setIsParallel", "interchange", "tile", "setCondRelation", "setCondRelation", "setBody", "setCond", "setThen", "setElse", "setLabel", "setDecl", "hasClause", "isClauseLegal", "getReduction", "removeClause", "setKind", "setNumThreads", "setProcBind", "setPrivate", "setReduction", "setDefault", "setFirstprivate", "setLastprivate", "setShared", "setCopyin", "setScheduleKind", "setScheduleChunkSize", "setScheduleChunkSize", "setScheduleModifiers", "setCollapse", "setCollapse", "setOrdered", "setText", "setName", "setContent", "getTargetNodes", "setInit", "setInit", "removeInit", "varref", "setStorageClass", "setName", "setLeft", "setRight", "setArrow", "setTemplateArgsTypes", "setTemplateArgType", "setDesugar", "setTypeFieldByValueRecursive", "setUnderlyingType", "asConst", "setReturnType", "setParamType", "setArgType", "setPointee", "setElementType", "setSizeExpr", "setInnerType"};
