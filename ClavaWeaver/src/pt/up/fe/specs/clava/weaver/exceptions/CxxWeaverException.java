 ...
 */
public class CxxWeaverException extends BaseException {
     ...
     */
    public CxxWeaverException(String event){
        this(event,null);
    }
    /**
     ...
     */
    public CxxWeaverException(String event, Throwable cause){
        super(cause);
        this.event = event;
    }
    /**
