...
/**
 * Auto-Generated class for join point AExprStmt
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AExprStmt extends AStatement {
     ...
     * 
     */
    public AExprStmt(AStatement aStatement){
    ...
    protected enum ExprStmtAttributes {
         ...
         * 
         */
        private ExprStmtAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<ExprStmtAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(ExprStmtAttributes::name).collect(Collectors.toList());
        }
