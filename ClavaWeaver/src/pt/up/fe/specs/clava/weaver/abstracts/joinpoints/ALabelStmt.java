...
/**
 * Auto-Generated class for join point ALabelStmt
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class ALabelStmt extends AStatement {
     ...
     * 
     */
    public ALabelStmt(AStatement aStatement){
     ...
     */
    public abstract ALabelDecl getDeclImpl();
    ...
    public void defDeclImpl(ALabelDecl value) {
        throw new UnsupportedOperationException("Join point "+get_class()+": Action def decl with type ALabelDecl not implemented ");
    }
    ...
    public void setDeclImpl(ALabelDecl label) {
        throw new UnsupportedOperationException(get_class()+": Action setDecl not implemented ");
    }
     ...
     * @param label 
     */
    public final void setDecl(ALabelDecl label) {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAction(Stage.BEGIN, "setDecl", this, Optional.empty(), label);
        	}
        	this.setDeclImpl(label);
        	if(hasListeners()) {
        		eventTrigger().triggerAction(Stage.END, "setDecl", this, Optional.empty(), label);
        	}
        } catch(Exception e) {
        	throw new ActionException(get_class(), "setDecl", e);
        }
    }
    ...
    public AJoinPoint[] getDescendantsAndSelfImpl(String type) {
        return this.aStatement.getDescendantsAndSelfImpl(type);
    }
    ...
    protected final void fillWithActions(List<String> actions) {
        ...
        actions.add("void setDecl(labelDecl)");
    }
    ...
    protected enum LabelStmtAttributes {
         ...
         * 
         */
        private LabelStmtAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<LabelStmtAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(LabelStmtAttributes::name).collect(Collectors.toList());
        }
