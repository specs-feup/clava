...
/**
 * Auto-Generated class for join point AQualType
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AQualType extends AType {
     ...
     */
    public abstract String[] getQualifiersArrayImpl();
    ...
    /**
     * Get value on attribute unqualifiedType
     * @return the attribute's value
     */
    public abstract AType getUnqualifiedTypeImpl();
    ...
    public final Object getUnqualifiedType() {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.BEGIN, this, "unqualifiedType", Optional.empty());
        	}
    ...
    public AJoinPoint[] descendantsAndSelfArrayImpl(String type) {
        return this.aType.descendantsAndSelfArrayImpl(type);
    }
    ...
    public AJoinPoint astChildImpl(Integer index) {
        return this.aType.astChildImpl(index);
    }
    ...
    public Object keyTypeImpl(String key) {
        return this.aType.keyTypeImpl(key);
    }
    ...
    public AJoinPoint chainAncestorImpl(String type) {
        return this.aType.chainAncestorImpl(type);
    }
    ...
    public String getJoinpointTypeImpl() {
        return this.aType.getJoinpointTypeImpl();
    }
    ...
    public AJoinPoint firstJpImpl(String type) {
        return this.aType.firstJpImpl(type);
    }
    ...
    public String javaFieldTypeImpl(String fieldName) {
        return this.aType.javaFieldTypeImpl(fieldName);
    }
    ...
    protected final void fillWithAttributes(List<String> attributes) {
        ...
        attributes.add("qualifiers");
        attributes.add("unqualifiedType");
    }
     ...
     * 
     */
    protected enum QualTypeAttributes {
         ...
         * 
         */
        private QualTypeAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<QualTypeAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(QualTypeAttributes::name).collect(Collectors.toList());
        }
