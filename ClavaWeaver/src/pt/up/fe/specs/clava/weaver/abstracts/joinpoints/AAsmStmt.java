...
/**
 * Auto-Generated class for join point AAsmStmt
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class AAsmStmt extends AStatement {
     ...
     * 
     */
    public AAsmStmt(AStatement aStatement){
        this.aStatement = aStatement;
    }
    /**
     * Get value on attribute clobbers
     * @return the attribute's value
     */
    public abstract String[] getClobbersArrayImpl();

    /**
     * Get value on attribute clobbers
     * @return the attribute's value
     */
    public Object getClobbersImpl() {
        String[] stringArrayImpl0 = getClobbersArrayImpl();
     ...
     * @return the attribute's value
     */
    public final Object getClobbers() {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.BEGIN, this, "clobbers", Optional.empty());
        	}
        	Object result = this.getClobbersImpl();
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.END, this, "clobbers", Optional.ofNullable(result));
        	}
        	return result!=null?result:getUndefinedValue();
        } catch(Exception e) {
        	throw new AttributeException(get_class(), "clobbers", e);
        }
    }

    /**
     * Get value on attribute isSimple
     * @return the attribute's value
     */
    public abstract Boolean getIsSimpleImpl();

    /**
     * Get value on attribute isSimple
     * @return the attribute's value
     */
    public final Object getIsSimple() {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.BEGIN, this, "isSimple", Optional.empty());
        	}
        	Boolean result = this.getIsSimpleImpl();
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.END, this, "isSimple", Optional.ofNullable(result));
        	}
        	return result!=null?result:getUndefinedValue();
        } catch(Exception e) {
        	throw new AttributeException(get_class(), "isSimple", e);
        }
    }

    /**
     * Get value on attribute isVolatile
     * @return the attribute's value
     */
    public abstract Boolean getIsVolatileImpl();

    /**
     * Get value on attribute isVolatile
     * @return the attribute's value
     */
    public final Object getIsVolatile() {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.BEGIN, this, "isVolatile", Optional.empty());
        	}
        	Boolean result = this.getIsVolatileImpl();
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.END, this, "isVolatile", Optional.ofNullable(result));
        	}
        	return result!=null?result:getUndefinedValue();
        } catch(Exception e) {
        	throw new AttributeException(get_class(), "isVolatile", e);
        }
    }
    ...
    protected final void fillWithAttributes(List<String> attributes) {
        ...
        attributes.add("clobbers");
        attributes.add("isSimple");
        attributes.add("isVolatile");
    }
     ...
     * 
     */
    protected enum AsmStmtAttributes {
        CLOBBERS("clobbers"),
        ISSIMPLE("isSimple"),
         ...
         * 
         */
        private AsmStmtAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<AsmStmtAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(AsmStmtAttributes::name).collect(Collectors.toList());
        }
