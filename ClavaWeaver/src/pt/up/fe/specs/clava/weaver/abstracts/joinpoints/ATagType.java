...
/**
 * Auto-Generated class for join point ATagType
 * This class is overwritten by the Weaver Generator.
 * 
 * 
 * @author Lara Weaver Generator
 */
public abstract class ATagType extends AType {
    ...
    protected enum TagTypeAttributes {
         ...
         * 
         */
        private TagTypeAttributes(String name){
            this.name = name;
        }
        /**
         * Return an attribute enumeration item from a given attribute name
         */
        public static Optional<TagTypeAttributes> fromString(String name) {
        ...
        public static List<String> getNames() {
            return Arrays.asList(values()).stream().map(TagTypeAttributes::name).collect(Collectors.toList());
        }
