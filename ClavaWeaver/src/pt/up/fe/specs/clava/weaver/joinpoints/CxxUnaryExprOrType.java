...
public class CxxUnaryExprOrType extends AUnaryExprOrType {
    ...
    public CxxUnaryExprOrType(UnaryExprOrTypeTraitExpr expr, ACxxWeaverJoinPoint parent) {
        super(new CxxExpression(expr, parent));
    ...
    public AType getArgTypeImpl() {
        ...
        return CxxJoinpoints.create(expr.getArgumentType().get(), this, AType.class);
    }
    ...
    public AExpression getArgExprImpl() {
        ...
        return CxxJoinpoints.create(expr.getArgumentExpression(), this, AExpression.class);
    }
